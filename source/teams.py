...
HARD = {
    "BURN": {
        "checks" : ["Burn", "smallBurn", (315, 370), "reBurn", "bigBurn", 0],
        "floors" : ["FlatbrokeGamblers", "HatredandDespair", "HellsChicken", "Line3", "Line2", "The_BE", "Line1", "Line3Terminus", "MiracleinDistrict20", "Line5", "MiracleinDistrict20BokGak", "Line1Madness", "AbnormalSeismicZone"],
