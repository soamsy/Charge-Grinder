...
BANNED = [
    ...
    "TobeCrushed",
    "TheNoonofViolet",
    "MurderontheWARPExpress",
    "FullStoppedbyaBullet",
    "VainPride",
    "CrawlingAbyss",
    "TimekillingTime",
    "NocturnalSweeping",
...
HARD_BANNED = [
    ...
    "FourHousesandGreed",
    "TheUnchanging",
    "MountainofCorpsesSeaofBlood",
    "TheInfiniteProcession",
    "TheDreamEnding",
    "TheHeartbreaking",
    "BridleofInfinity",
    "LakeWorld",
